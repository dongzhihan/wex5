...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1" bind-click="panel1Click" bind-keydown="panel1Keydown" tabindex='1'> 
  ...
  <div xid="div3" style="width:65%;height:12%;margin:10px auto auto auto;" class="center-block  ">
    ...
    <div xid="div4" style="width:60%;height:12%;margin:10px auto auto auto;" class="center-block"></div>
    <div xid="div5" style="width:60%;height:12%;margin:10px auto auto auto;" class="center-block"></div>
