...
<span component="$UI/system/components/justep/windowReceiver/windowReceiver" xid="windowReceiver1"></span><div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <ul xid="ul1">
  	<li><span>用          户：<span bind-text="userName"></span></span></li>
  	<li><span>当前任务：<span bind-text="mission"></span></span></li>
  	<li><span>处理总量：<span bind-text="total"></span></span></li>
  	<li><span>盘点货位：<span bind-text="number"></span></span></li>
  	<li><span>盘点时间：<span bind-text="time"></span></span></li>
  	<li><span>盘点效率：<span bind-text="efficiency"></span></span></li>
  	<li><span>下一货位：<span bind-text="next"></span></span></li>
  </ul>
  
  
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="" xid="button1" bind-click="button1Click" style="margin-top:1.5rem">
   <i xid="i1"></i>
