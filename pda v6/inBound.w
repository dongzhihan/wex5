...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog1" src="$UI/mushiny/login3.w"></span>
  <div tabindex='1' component="$UI/system/components/justep/panel/panel" 
   ...
   <div class="x-titlebar-title" style="width:262px;" xid="title1">请选择Inbound工作类型</div></div></div>  
    <div class="x-panel-content" xid="content1" style="width:100%;top:2rem;height:100%;">
