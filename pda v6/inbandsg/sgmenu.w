...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window container-fluid">  
  ...
  <span component="$UI/system/components/justep/windowReceiver/windowReceiver" xid="windowReceiversg" onReceive="windowReceiver1Receive"></span><div component="$UI/system/components/justep/panel/panel" 
   ...
   </div><div class="x-titlebar-title" style="width:262px;">上架菜单</div>  
  ...
  <div xid="div7"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row2" style="width:100%;margin:0px 0px 5px 0px;padding:0px 0px 0px 0px;height:10%;">
   <div class="x-col" xid="col6" style="height:100%;width:100%;">
    <div xid="div1" style="width:100%;height:63%;text-align:center;">
     ...
     <input component="$UI/system/components/justep/input/input" class="form-control" xid="input5" id="hotkey" style="width:20%;display:inline-block;font-weight:bold;font-size:0.5rem;" bind-keydown="input5Keydown"></input></div> </div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1" style="width:100%;height:40%;text-align:center;">
   <div class="x-col" xid="col1">
    <div xid="div2" >
     <ul xid="ul1" dir="ltr">
      <li class="listyle" xid="li2">1—单件上架</li>
      <li class="listyle" xid="li3">2—批量上架</li>
      <li class="listyle" xid="li4">3—商品残损</li>
      <li class="listyle" xid="li5">4—信息查询</li>
      <li class="listyle" xid="li6">5—报告暗灯</li>
      <li class="listyle" xid="li1">6—结束上架</li></ul> </div> </div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row3" style="text-align:center;">
   <div class="x-col" xid="col5"><a component="$UI/system/components/justep/button/button" class="btn btn-default clr" label="确定" xid="button1" onClick="button1Click" style="background: linear-gradient(#5C81CA,#2F62BB );font-family:微软雅黑;">
   <i xid="i1"></i>
   <span xid="span2">确定</span></a></div>
   <div class="x-col" xid="col7"><a component="$UI/system/components/justep/button/button" class="btn btn-default clr" label="取消" xid="button2" onClick="button2Click" style="background: linear-gradient(#5C81CA,#2F62BB );font-family:微软雅黑;">
   <i xid="i2"></i>
