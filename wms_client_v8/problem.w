...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <span component="$UI/system/components/justep/windowDialog/windowDialog" xid="windowDialog1" src="$UI/mushiny/login3.w" routable="false" resizable="false"></span>
  <div tabindex='1' component="$UI/system/components/justep/panel/panel" 
    class="x-panel x-full" xid="panel1" bind-click="panel1Click" bind-keydown="panel1Keydown"> 
   ...
   <div class="x-titlebar-title" style="width:262px;" xid="title1">请选择PROBLEM工作类型</div></div></div>  
    <div class="x-panel-content" xid="content1" style="background-color:transparent;width:100%;height:100%;top:2rem;">
