...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window" design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad" onActive="modelActive"><div component="$UI/system/components/justep/data/data" autoLoad="true" xid="ordersData" idColumn="name"><column label="name" name="name" type="String" xid="xid1"></column>
...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
  ...
  <div xid="orderErrorCon" class="errorCon"><span xid="orderErrorMsg" class="errorMsg">
   </span></div>      <a component="$UI/system/components/justep/button/button" class="btn btn-default center-block" label="返回" xid="quit" style="margin-top:0.5rem;width:2rem;font-size:0.47rem;font-weight:bold;font-family:微软雅黑;color:#000000;background-color:#FFC000;" onClick="quitClick" bind-keypress="quitKeypress">
   <i xid="i5"></i>
   <span xid="span5">返回</span></a></div>
  <div class="x-contents-content" xid="content4" onActive="content4Active" onInactive="content4Inactive">
  <label xid="label3" class="tittle" bind-text="tittle"></label>
  <img src="../img/computer.png" alt="" xid="image1" class="center-block" align="middle" style="height:194px;margin-top: 0.5rem"></img>
  <input component="$UI/system/components/justep/input/input" class="form-control" xid="input1" style="width:70%;margin:auto" bind-keydown="input1Keydown"></input>
